...
1. [Клиент-серверное приложение](./task1/README.md#1);
1. [Клиент-серверное приложение](./task1/README.md#my-custom-anchor-point);
2. [Клиент-сервер с рюшечками](./task2/README.md#2)* (необязательна к выполнению).
